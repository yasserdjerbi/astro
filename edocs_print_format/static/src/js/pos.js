function process_action_x_pagos()
{
    ...
    $.ajax({
                type: "POST",
                url: '/edocs_print_format/x_report_payments',
...
odoo.define("edocs_print_format.efact_Pos", function (require) {
    "use strict";
    ...
    models.load_fields('res.partner', 'dian_tipo_documento');
    ...
    var widget = require('point_of_sale.BaseWidget');
    ...
    models.PosModel = models.PosModel.extend({
        initialize: function (session, attributes) {
            ...
            partner_model.fields.push('dian_tipo_documento');
    ...
    screens.ReceiptScreenWidget.include({
        format_currency_report: function(amount,precision) {
        ...
        pos_reference: function() {
            ...
            $.ajax({
                        type: "POST",
                        url: '/edocs_print_format/get_pos_reference',
                        data: JSON.stringify(data),
                        dataType: 'json',
                        contentType: "application/json",
                        async: false,
                ...
                if (product.taxes_id.length){
                    for(var i=0;i<product.taxes_id.length;i++)
                    {
                       ...
                       var groupTaxItem = {
                                            ...
                                            'amount':amount,
                                            'price_unit':String(format3(price_unit,this.pos.currency.symbol)).replace(".00",""),
